...
class GenerationMixin:
    ...
    def _dola_decoding(
        ...
        **model_kwargs,
        ...
        print("checker: Sample is running in _dola_decoding -> 1")
    ...
    def _contrastive_search(
        ...
        **model_kwargs,
        ...
        this_peer_finished = False
        print("checker: Sample is running in _contrastive_search ->2")
    ...
    def _sample(
        ...
        **model_kwargs,
        ...
        # added latency to the native transformers
        token_latency = True
        # token_latency = (
        #     True if hasattr(generation_config, "token_latency") else False
        # )
        ...
        this_peer_finished = False
        print("checker: Sample is running in _sample() -> 3")
        unfinished_sequences = torch.ones(batch_size, dtype=torch.long, device=input_ids.device)
        model_kwargs = self._get_initial_cache_position(input_ids, model_kwargs)
    ...
    def _beam_search(
        ...
        **model_kwargs,
        ...
        print("checker: Sample is running in _beam_search ->4")
        this_peer_finished = False
    ...
    def _group_beam_search(
        ...
        **model_kwargs,
        ...
        beam_scores = beam_scores.view((batch_size * num_beams,))
        print("checker: Sample is running in _group_beam_search ->5")
        this_peer_finished = False
    ...
    def _constrained_beam_search(
        ...
        **model_kwargs,
        ...
        beam_scores[:, 1:] = -1e9
        beam_scores = beam_scores.view((batch_size * num_beams,))
        print("checker: Sample is running in _constrained_beam_search ->6")
        this_peer_finished = False
    ...
    def _assisted_decoding(
        ...
        **sample** (depending on `do_sample`), assisted by candidate sequences. Assisted generation is an example of a
        ...
        unfinished_sequences = torch.ones(batch_size, dtype=torch.long, device=input_ids.device)
        model_kwargs = self._get_initial_cache_position(input_ids, model_kwargs)
        print("checker: Sample is running in _assisted_decoding -> 7")
        this_peer_finished = False
